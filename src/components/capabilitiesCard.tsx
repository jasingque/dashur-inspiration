...
export const TrustCard = memo(({ label, imageUrl, title }: Omit<CapabilityItem, "id">) => {
  return (
    <div className="group relative flex h-full w-[280px] shrink-0 flex-col justify-between overflow-hidden rounded-2xl border border-white/20 bg-linear-to-b from-[#191c30] to-[#0b0e23] p-6 transition-transform hover:-translate-y-1">
