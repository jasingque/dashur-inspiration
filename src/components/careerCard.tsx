...
export const CaseStudyCard = ({
  ...
  return (
    <div
      ...
      className="group relative flex cursor-pointer w-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-linear-to-b from-[#191C30] to-[#0B0E23] p-4 transition-all duration-300 hover:-translate-y-5 hover:border-[#4988C4] hover:shadow-[0_10px_30px_rgba(0,0,0,0.25)] md:flex-row md:items-stretch md:gap-8 md:p-6"
    >
